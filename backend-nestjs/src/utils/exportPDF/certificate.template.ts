export const certificateTemplate = (name: string, course_name: string): string => `
<html>
  <head>
    <style>
    .cursive {
            ...
            <div class="col-xs-12">
              <div class="row">
                ...
                <div class="pm-course-title col-xs-8 text-center">
                  <span class="pm-earned-text block cursive">Đã hoàn thành khóa học</span>
                </div>
                <div class="col-xs-2"><!-- LEAVE EMPTY --></div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="pm-certificate-footer">
                <div class="col-xs-4 pm-certified col-xs-4 text-center">
                  <span class="pm-credits-text block sans">KAKEHASHI</span>
